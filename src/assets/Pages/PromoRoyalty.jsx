      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8 px-4 md:px-10">
        ...
        <div className="bg-white shadow-xl rounded-2xl p-6 min-h-[500px]">
          ...
          <div className="flex bg-gray-100 rounded-xl overflow-hidden shadow-md mb-8 min-h-[180px]">
            <img src={gym1} alt="June Fit Challenge" className="w-48 h-auto object-cover" />
            <div className="p-5 flex flex-col justify-between flex-1">
              <div>
                <span className="text-sm bg-green-200 px-3 py-1 rounded-full">Monthly</span>
                <h4 className="text-xl font-bold mt-3 mb-2">June Fit Challenge</h4>
                <p className="text-base text-gray-600 mb-3">Periode: 1 – 30 Juni</p>
              </div>
              <button
          ...
          <div className="flex bg-gray-100 rounded-xl overflow-hidden shadow-md min-h-[180px]">
            <img src={gym1} alt="Summer Body Goals" className="w-48 h-auto object-cover" />
            <div className="p-5 flex flex-col justify-between flex-1">
              <div>
                <span className="text-sm bg-pink-200 px-3 py-1 rounded-full">Challenge</span>
                <h4 className="text-xl font-bold mt-3 mb-2">Summer Body Goals</h4>
                <p className="text-base text-gray-600 mb-3">Periode: 10 – 20 Juni</p>
              </div>
              <button
                className="bg-blue-600 hover:bg-blue-700 text-white text-sm px-5 py-2 rounded-md w-max"
                onClick={() =>
        ...
        <div className="bg-white shadow-xl rounded-2xl p-8 flex flex-col justify-start min-h-[500px] space-y-6">
          <h3 className="text-2xl font-semibold text-gray-800">🤝 Referral & Loyalty</h3>
          ...
          <div>
            ...
            <p className="text-sm mt-1 text-green-700">🎁 2 lagi untuk dapat diskon 50%</p>
          </div>
      ...
      {selectedPromo && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50 px-4">
          <div className="bg-white rounded-xl shadow-2xl p-8 w-full max-w-2xl">
            ...
            <p className="text-sm text-gray-500 mb-1">Periode: {selectedPromo.period}</p>
            <p className="text-base text-gray-700 mb-6 leading-relaxed">{selectedPromo.description}</p>
